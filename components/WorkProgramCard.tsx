...
export default function WorkProgramCard({
  ...
  return (
    <article className="group flex h-full flex-col rounded-3xl border border-amber-100 bg-white/90 p-6 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-suhaai-gold/75 hover:shadow-[0_18px_42px_rgba(18,53,91,0.10)] sm:p-7">
      ...
      <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl border border-suhaai-gold/45 bg-suhaai-gold/10 text-suhaai-green transition-all duration-300 group-hover:border-suhaai-gold group-hover:bg-suhaai-gold/15">
        <svg
          aria-hidden="true"
          className="h-6 w-6"
          fill="none"
      ...
      <div className="flex flex-1 flex-col">
        ...
        <p className="mt-4 text-base leading-7 text-suhaai-ink/78">
          {text}
        </p>

        <Link
          href={href}
          className="mt-5 inline-flex w-fit items-center gap-2 rounded-full border border-suhaai-gold bg-suhaai-gold px-4 py-2 text-sm font-extrabold text-suhaai-green shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#e2a92f] hover:bg-[#e2a92f] hover:shadow-[0_12px_28px_rgba(244,185,66,0.28)] focus:outline-none focus:ring-2 focus:ring-suhaai-gold focus:ring-offset-2"
        >
          Learn More
          <span
            aria-hidden="true"
